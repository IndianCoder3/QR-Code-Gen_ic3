...
1. Download the latest `qrcode-gen-setup-v*.exe` (replace * with the version, do the same for the rest of the time) from the [Releases page](https://github.com/IndianCoder3/QR-Code-Gen_ic3/releases).
...
1. Download `GUI-v1.py` or the source code archive from the [Releases page](https://github.com/IndianCoder3/QR-Code-Gen_ic3/releases).
...
Contributions, issues, and feature requests are welcome! Feel free to check [issues](https://github.com/IndianCoder3/QR-Code-Gen_ic3/issues).
...
Created by [IndianCoder3](https://github.com/IndianCoder3).
